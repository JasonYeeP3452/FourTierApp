...
/**
 * 
 * The class is used to connect to the database.
 * Thus, you will seeing the database URL, username, password.
 * According to the class name, we can know that the class is responsible for manipulate records inside Student table.
 */
public class StudentDA {
    ...
    public Student getRecord(String id) {
        ...
        try {
            ...
            stmt.setString(1, id);
            // success construct sql "Select * from STUDENT where ID = '12WAD34567'"
